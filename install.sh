...
#########################
CDNF="https://raw.githubusercontent.com/rezaakbar5/ps/master"
...
echo ""
wget -q https://raw.githubusercontent.com/rezaakbar5/ps/master/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/rezaakbar5/ps/master/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install XRAY!"
sleep 2
clear
wget https://raw.githubusercontent.com/rezaakbar5/ps/master/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
echo -e "$green[INFO]$NC Install SET-BR!"
wget https://raw.githubusercontent.com/rezaakbar5/ps/master/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
echo -e "$green[INFO]$NC Install WEBSOCKET!"
wget https://raw.githubusercontent.com/rezaakbar5/ps/master/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
wget https://raw.githubusercontent.com/rezaakbar5/ps/master/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
echo -e "$green[INFO]$NC Download Extra Menu"
sleep 2
wget https://raw.githubusercontent.com/rezaakbar5/ps/master/update/update.sh && chmod +x update.sh && ./update.sh
rm -f update.sh
clear
echo -e "$green[INFO]$NC INSTALL SLOWDNS"
sleep 2
wget https://raw.githubusercontent.com/rezaakbar5/ps/master/slowdns/installsl.sh && chmod +x installsl.sh && ./installsl.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/rezaakbar5/ps/master/version  )
